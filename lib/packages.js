...
const packages = {
	...
	"fastify-hello-world": { extra: true, package: "fastify", checked: true, hasRouter: true },
	"express-listing": { extra: true, package: "express", hasRouter: true },
	"fastify-listing": { extra: true, package: "fastify", hasRouter: true },
	"fastify-listing-json": { extra: true, package: "fastify", hasRouter: true }
};
