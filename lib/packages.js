...
const packages = {
	...
	"fastify-hello-world": { extra: true, package: "fastify", hasRouter: true },
	...
	"express-final": { extra: true, package: "express", hasRouter: true },
	"fastify-final": { extra: true, package: "fastify", hasRouter: true }
};
